...
public class DelabItems
{
    ...
    public static final DeferredItem<Item> FROZEN_COWING_SPAWN_EGG = ITEMS.register("frozen_cowing_spawn_egg",
            () -> new DeferredSpawnEggItem(DelabEntityTypes.FROZEN_COWING, 4470310, 14543594,
                    new Item.Properties()));
    public static final DeferredItem<Item> EVIL_SPITTER_SPAWN_EGG = ITEMS.register("evil_spitter_spawn_egg",
            () -> new DeferredSpawnEggItem(DelabEntityTypes.EVIL_SPITTER, 0x00ff00, 0xff00ff,
                    new Item.Properties()));
